...
(function(exports) {
  ...
  var updateForm = function (sel) {
      return function (value) {
          return function __do() {
              ...
              throw new Error("Failed pattern match at Main line 112, column 24 - line 117, column 1: " + [ v.constructor.name ]);
          };
      };
  };
  var toFormData = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 94, column 1 - line 111, column 1: " + [ v.constructor.name ]);
  };
  ...
  var loadSavedData = function __do() {
      ...
      var savedData = (function () {
          var readItem = Data_Foreign_Class.read(Data_Foreign_Class.nullIsForeign(Data_Foreign_Class.stringIsForeign))(v);
          return Prelude.bind(Data_Either.bindEither)(readItem)(function (v1) {
              var x = Data_Foreign_Null.runNull(v1);
              return Data_Traversable.traverse(Data_Traversable.traversableMaybe)(Data_Either.applicativeEither)(Data_Foreign_Class.readJSON(formData2IsForeign))(x);
          });
      })();
