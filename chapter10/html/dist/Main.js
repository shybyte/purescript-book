...
(function(exports) {
  ...
  var updateForm = function (sel) {
      return function (value) {
          return function __do() {
              ...
              throw new Error("Failed pattern match at Main line 76, column 24 - line 81, column 1: " + [ v.constructor.name ]);
          };
      };
  };
  var toFormData = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 58, column 1 - line 75, column 1: " + [ v.constructor.name ]);
  };
  var validateAndSaveEntry = function __do() {
      ...
      (function () {
          ...
          throw new Error("Failed pattern match at Main line 113, column 3 - line 119, column 3: " + [ v.constructor.name ]);
      })()();
      return Prelude.unit;
  };
  ...
  var loadSavedData = function __do() {
      ...
      throw new Error("Failed pattern match at Main line 91, column 3 - line 107, column 1: " + [ savedData.constructor.name ]);
  };
  var main = function __do() {
      ...
      throw new Error("Failed pattern match at Main line 122, column 8 - line 136, column 1: " + [ v.constructor.name ]);
  };
